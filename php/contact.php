<?php
 //Recepient Email Address
    ...
    $message .= "<tr><td style='background: #eee;'><strong>Name:</strong> </td><td>" . strip_tags($_POST['fullname']) . "</td></tr>";
    $message .= "<tr><td style='background: #eee;'><strong>Phone no. :</strong> </td><td>" . strip_tags($_POST['phone']) . "</td></tr>";
    $message .= "<tr><td style='background: #eee;'><strong>Email Address :</strong> </td><td>" . strip_tags($_POST['email_address']) . "</td></tr>";
    $message .= "<tr><td style='background: #eee;'><strong>Message :</strong> </td><td>" . strip_tags($_POST['message']) . "</td></tr>";
    $message .= "</table>";
    $message .= "</body></html>";
    ...
    $headers = "From: ".$_POST['fullname']." - " .$_POST['email_address'];
    ...
    else
    {
        ...
        //$headers = "From: SIGNIWIS <info@signiwis.com>" . $eol;
        $headers = "From: ".$_POST['fullname']." - " .$_POST['email_address'];
